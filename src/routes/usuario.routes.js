...
const { usuarioUpload } = require('../config/multer'); // Middleware multer correcto
const { validateRegistro } = require('../middlewares/validators/usuario.validator'); // Validación de datos
